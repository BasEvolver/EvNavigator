-- =================================================================
-- SEED SCRIPT V4 (HIERARCHICAL SCORING & FULL RATIONALE - CORRECTED NAMES)
-- =================================================================
...
INSERT INTO assessment_scores (assessment_id, item_id, item_type, source_id, as_is_score, to_be_score, as_is_rationale, as_is_confidence_score, as_is_confidence_rationale) VALUES
    -- User discovers issues, scores specific Capabilities and Levers lower.
    -- The D3 Discipline score will now be CALCULATED from this, overriding the old direct score.
    ...
    -- ARIA confirms with high confidence
...
INSERT INTO assessment_scores (assessment_id, item_id, item_type, source_id, as_is_score, to_be_score, as_is_rationale, as_is_confidence_score, as_is_confidence_rationale) VALUES
    -- A high-level Capability score is set for Product Innovation
    (5, 'C402', 'capability', 'Evelyn Reed', 3.8, 5.0, 'Overall innovation is strong, but specific new initiatives are lagging.', NULL, NULL),
    -- But a specific LEVER underneath it is scored much lower, representing the AI feature problem.
    ...
    -- ARIA confirms the AI feature gap at the lever level.
...
-- Step 2.3: Populate the Committed_Scores table
INSERT INTO committed_scores (assessment_id, item_id, item_type, source_id, as_is_score, to_be_score, rationale) VALUES
    (3, 'C201', 'capability', 'Consensus', 3.0, 4.5, 'Consensus: The GTM function is effective but informal. Target requires implementing a formal sales methodology.'),
    (3, 'C301', 'capability', 'Consensus', 2.8, 4.5, 'Consensus: The finance function is a key risk due to manual processes. Target requires investment in new systems.'),
    (4, 'C201', 'capability', 'Consensus', 4.2, 4.8, 'Consensus: VCP execution has been strong. The GTM function has matured significantly. New target focuses on optimization.'),
    (4, 'C301', 'capability', 'Consensus', 3.8, 4.5, 'Consensus: Excellent progress. New systems are in place. Target remains relevant as we focus on leveraging them for BI.');
