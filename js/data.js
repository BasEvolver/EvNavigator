...
const diligencePlan_v3 = [
    ...
    { id: "DD-34", name: "Net Promoter Score", duration: 0.3, dependencies: ["DD-28", "DD-33"], startDay: 4, workstream: "Commercial & Customer", category: "Customers", critical: false, description: "Review NPS data and customer feedback.", output: "NPS trend analysis." },
    ...
    // Financial & Risk
    { id: "DD-40", name: "Financial Statement Analysis", duration: 0.3, dependencies: [], startDay: 4, workstream: "Financial & Risk", category: "Financial & Accounting", critical: true, description: "Analyze historical income statements, balance sheets, and cash flow statements.", output: "Historical financial performance summary." },
    ...
    { id: "DD-50", name: "Tax Analysis", duration: 0.2, dependencies: ["DD-47"], startDay: 5, workstream: "Financial & Risk", category: "Financial & Accounting", critical: false, description: "Review tax returns and ensure compliance.", output: "Tax diligence report." },
...
// Add impact and complexity to existing levers
