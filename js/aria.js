...
// Add a hidden file input when the page loads
if (!document.getElementById('file-attachment-input')) {
    document.body.insertAdjacentHTML('beforeend', `<input type="file" id="file-attachment-input" style="display: none;" />`);
    document.getElementById('file-attachment-input').addEventListener('change', handleFileAttachment);
}
