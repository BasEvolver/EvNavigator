...
const portcoResponses = {
    ...
    "Can we start the analysis 2 days earlier?": {
        renderFunc: () => {
            ...
            return `<div class="portfolio-response-card"><p>I've re-planned the project to start non-dependent analysis workstreams two days earlier. Several key financial and legal tasks are now 'In Progress' today, which should help us get ahead of any potential issues.</p>${newGanttHTML}</div>`;
        },
    ...
    "Summarize the key risks for Commercial & Customer.": {
        renderFunc: () => `<div class="portfolio-response-card"><h4 class="response-title">Key Risks: Commercial & Customer</h4><p class="response-text">The key commercial risks identified are:</p><ul class="list-disc pl-6 mt-2 text-secondary"><li><strong>Customer Concentration:</strong> The top 2 customers account for 28% of ARR, and a key contract is up for renewal soon with unfavorable terms.</li><li><strong>Inefficient Funnel:</strong> A significant (80%) drop-off from MQL to SQL indicates a misalignment between sales and marketing.</li><li><strong>Poor Revenue Quality:</strong> A flat pricing model and lack of an expansion-focused sales motion are limiting NRR and LTV.</li></ul></div>`,
        recommendedActions: [
            { text: "Draft IC memo slide", description: "Summarize these risks for the Investment Committee.", prompt: "Draft an IC memo slide for this section." },
    ...
    "Summarize the key risks for Technology & Operations.": {
        renderFunc: () => `<div class="portfolio-response-card"><h4 class="response-title">Key Risks: Technology & Operations</h4><p class="response-text">The primary technology and operational risks are:</p><ul class="list-disc pl-6 mt-2 text-secondary"><li><strong>Technical Debt:</strong> The legacy monolithic architecture is hindering scalability and developer velocity, requiring a costly and lengthy migration.</li><li><strong>Failed Product Launches:</strong> The last three product launches have generated zero revenue, indicating issues with product-market fit and GTM execution.</li><li><strong>Inefficient R&D:</strong> Developer velocity is well below industry benchmarks, while R&D spend as a percentage of revenue is too high.</li></ul></div>`,
        recommendedActions: [
            { text: "Draft IC memo slide", description: "Summarize these risks for the Investment Committee.", prompt: "Draft an IC memo slide for this section." },
    ...
    "Analyze the key drivers of our Net Revenue Retention.": {
        renderFunc: () => `<div class="portfolio-response-card"><h4 class="response-title">NRR Driver Analysis (128%)</h4><p class="response-text">The exceptional 128% NRR is primarily driven by two factors:</p><ol class="list-decimal pl-6 mt-2 text-secondary"><li><strong>Expansion to Enterprise Tier:</strong> 60% of the expansion ARR came from 15 mid-market customers upgrading to the new Enterprise pricing tier.</li><li><strong>Cross-sell of 'Analytics Suite':</strong> 30% of the expansion ARR was generated by cross-selling the new Analytics module into the existing customer base.</li></ol><p class="response-text mt-2">Gross Revenue Retention remains healthy at 96%, indicating low logo churn.</p></div>`,
        recommendedActions: [
